...
/// <summary>
/// Defines the public API for <see cref="BradixScrollAreaThumb"/>.
/// </summary>
public interface IBradixScrollAreaThumb
{
    ...
    /// <summary>Gets or sets whether the thumb stays mounted when not visible.</summary>
