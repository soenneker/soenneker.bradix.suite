...
/// <summary>Defines the public API for <see cref="BradixMenuSubContent"/>.</summary>
public interface IBradixMenuSubContent
{
    ...
    /// <summary>Gets or sets additional attributes spread onto the inner content element.</summary>
