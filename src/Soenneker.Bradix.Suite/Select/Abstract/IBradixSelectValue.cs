...
/// <summary>
/// Defines the public API for <see cref="BradixSelectValue"/>.
/// </summary>
public interface IBradixSelectValue
{
    ...
    /// <summary>Gets or sets the placeholder shown when no value is selected.</summary>
