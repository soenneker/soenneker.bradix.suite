...
/// <summary>Defines the public API for <see cref="BradixDropdownMenuRadioGroup"/>.</summary>
public interface IBradixDropdownMenuRadioGroup
{
    ...
    /// <summary>Gets or sets the controlled value.</summary>
