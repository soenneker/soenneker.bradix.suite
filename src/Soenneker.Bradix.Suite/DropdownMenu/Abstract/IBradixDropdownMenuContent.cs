...
/// <summary>Defines the public API for <see cref="BradixDropdownMenuContent"/>.</summary>
public interface IBradixDropdownMenuContent
{
    ...
    /// <summary>Gets or sets the element id for the content region.</summary>
    string? Id { get; set; }
