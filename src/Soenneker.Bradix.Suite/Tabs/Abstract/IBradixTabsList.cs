...
/// <summary>
/// Defines the public API for <see cref="BradixTabsList"/>.
/// </summary>
public interface IBradixTabsList
{
    ...
    /// <summary>Gets or sets whether keyboard navigation wraps at the ends of the tab list.</summary>
    bool Loop { get; set; }
}
