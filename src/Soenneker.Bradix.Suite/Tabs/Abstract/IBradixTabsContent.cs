...
/// <summary>
/// Defines the public API for <see cref="BradixTabsContent"/>.
/// </summary>
public interface IBradixTabsContent
{
    ...
    /// <summary>Gets or sets the value identifying the associated tab trigger.</summary>
    string Value { get; set; }

    /// <summary>Gets or sets whether the panel stays mounted when inactive.</summary>
