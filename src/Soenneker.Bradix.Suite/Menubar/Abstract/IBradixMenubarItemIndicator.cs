...
/// <summary>Defines the public API for <see cref="BradixMenubarItemIndicator"/>.</summary>
public interface IBradixMenubarItemIndicator
{
    /// <summary>Gets or sets a value indicating whether the indicator is mounted while inactive for measurement.</summary>
