...
/// <summary>Defines the public API for <see cref="BradixMenubarRadioItem"/>.</summary>
public interface IBradixMenubarRadioItem
{
    ...
    /// <summary>Gets or sets the value of this radio item.</summary>
