...
using Soenneker.Bradix.Suite.Toolbar;
using Xunit;

namespace Soenneker.Bradix.Suite.Tests;

public sealed class BradixToolbarRenderTests : Bunit.BunitContext
{
    ...
    private static RenderFragment CreateToolbar()
    {
        return builder =>
        {
            ...
            builder.AddAttribute(1, nameof(BradixToolbar.ChildContent), (RenderFragment) (contentBuilder =>
            {
                ...
                contentBuilder.AddAttribute(41, nameof(BradixToolbarToggleGroup.Type), "single");
