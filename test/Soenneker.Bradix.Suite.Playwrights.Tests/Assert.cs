...
internal static class Assert
{
    ...
    public static void DoesNotContain<T>(IEnumerable<T> values, Func<T, bool> predicate, string? message = null)
    {
        if (values.Any(predicate))
            throw new Exception(message ?? "Found an unexpected matching value in the collection.");
    }
}
