# RunDemo.ps1
# Clean + restore + build + run the Bradix Suite demo for browser/Codex testing.
...
# Bradix repo
$DemoProjectDir = Join-Path $PSScriptRoot "test\Soenneker.Bradix.Suite.Demo"
$DemoProject = Join-Path $DemoProjectDir "Soenneker.Bradix.Suite.Demo.csproj"

$BradixSuiteDir = Join-Path $PSScriptRoot "src\Soenneker.Bradix.Suite"
...
function Stop-LingeringDemoProcesses {
    ...
    $escapedProject = [regex]::Escape("Soenneker.Bradix.Suite.Demo.csproj")
